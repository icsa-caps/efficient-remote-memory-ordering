...
static struct argp_option options[] = {
  ...
  {"outfile", OPT_OUTFILE, "FILE", 0, "Output CSV file path (default: results/write_lat.csv)" },
  { 0 }
};
...
int main(int argc, char **argv) {
  struct arguments arguments = {16, 64, 1, 1, false, SERVER_IP, SERVER_PORT, "results/write_lat.csv"};
